...
### 2. 独立设置页面 ⏳
**状态**: 当前settings功能分散，需要独立设计

**未完成项**:
- [ ] 创建独立`/settings`路由页面
- [ ] Agent配置界面（提示词编辑器、新增agent）
- [ ] 工具配置界面（启用/禁用、参数配置）
- [ ] 系统配置（LLM Provider、API Key、模型参数）
- [ ] 知识库配置
- [ ] 主题和显示设置
...
### 3. CrewAI节点属性配置 ⏳
**状态**: Canvas已实现，但节点配置面板缺失

**未完成项**:
- [ ] Agent节点属性面板（Role, Goal, Backstory, Tools）
- [ ] Task节点属性面板（Description, Expected Output, Agent）
- [ ] 节点编辑保存到配置
- [ ] 属性验证

**影响**: 用户无法精细配置Agent和Task
...
### 6. 项目文档整理 ⏳
**状态**: 根目录93个MD文件，需要归档和清理

**未完成项**:
- [ ] 归档过期文档到`docs/archive/2025-10-30/`
- [ ] 更新`README.md`（最新功能列表）
